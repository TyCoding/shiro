...
(function (r) {
    var J, K, L, M, N, O, v, t = {}, w = {}, x = {}, P = {
        ...
        var b = a.target, c = e.getSetting(a.data.treeId), d = "", f = null, i = "", m = "", k = null, j = null,
            o = null;
        if (h.eqs(a.type, "mousedown")) m = "mousedown"; else if (h.eqs(a.type, "mouseup")) m = "mouseup"; else if (h.eqs(a.type, "contextmenu")) m = "contextmenu"; else if (h.eqs(a.type, "click")) if (h.eqs(b.tagName, "span") && b.getAttribute("treeNode" +
            g.id.SWITCH) !== null) d = h.getNodeMainDom(b).id, i = "switchNode"; else {
            if (o = h.getMDom(c, b, [{
                tagName: "a",
        ...
        if (d.length > 0) switch (f = e.getNodeCache(c, d), i) {
            case "switchNode":
                e.nodeIsParent(c,
                    f) ? h.eqs(a.type, "click") || h.eqs(a.type, "dblclick") && h.apply(c.view.dblClickExpand, [c.treeId, f], c.view.dblClickExpand) ? k = J : i = "" : i = "";
                break;
            case "clickNode":
                k = K
        }
        ...
        addInitProxy: function (a, b) {
            ...
            for (var f = [], d = d.toLowerCase(), i = 0, m = b.length; i < m; i++) {
                var k = b[i];
                typeof k[c] == "string" && b[i][c].toLowerCase().indexOf(d) > -1 &&
                f.push(k);
                k = e.nodeChildren(a, k);
            ...
            if (!b) return null;
            for (var c = b.parentTId ? b.getParentNode() : e.getRoot(a), c = e.nodeChildren(a, c), d = 0, f = c.length; d < f; d++) if (c[d] === b) return d ==
            0 ? null : c[d - 1];
            return null
        }, getRoot: function (a) {
        ...
        bindEvent: function (a) {
            ...
            a.view.txtSelectedEnable || c.bind("selectstart",
                v).css({"-moz-user-select": "-moz-none"});
    ...
    J = function (a, b) {
        ...
        if (b.open) {
            if (h.apply(c.callback.beforeCollapse, [c.treeId, b], !0) ==
                !1) return !0
    ...
    K = function (a, b) {
        ...
        c.treeObj.trigger(g.event.CLICK,
            [a, c.treeId, b, d]);
        return !0
    };
    L = function (a, b) {
    ...
    var h = {
        ...
        addNodes: function (a, b, c, d, f) {
            ...
            if (!a.data.keep.leaf || !b || i) if (h.isArray(d) || (d = [d]), a.data.simpleData.enable && (d = e.transformTozTreeFormat(a, d)), b) {
                ...
                e.getRoot(a), c, d), j.createNodes(a, 0, d, null, c)
            ...
            for (var s = 0, n = c.length; s < n; s++) {
                ...
                g && (j.makeDOMNodeMainBefore(k, a, p), j.makeDOMNodeLine(k,
                    a, p), e.getBeforeA(a, p, k), j.makeDOMNodeNameBefore(k, a, p), e.getInnerBeforeA(a, p, k), j.makeDOMNodeIcon(k, a, p), e.getInnerAfterA(a, p, k), j.makeDOMNodeNameAfter(k, a, p), e.getAfterA(a, p, k), o && p.open && j.makeUlHtml(a, p, k, l.join("")), j.makeDOMNodeMainAfter(k, a, p), e.addCreatedNode(a, p))
            }
            return k
            ...
            if (a.callback.onNodeCreated || a.view.addDiyDom) for (var b = e.getRoot(a); b.createdNodes.length > 0;) {
                ...
                a.callback.onNodeCreated &&
                a.treeObj.trigger(g.event.NODECREATED, [a.treeId, c])
            }
        ...
        expandCollapseNode: function (a, b, c, d, f) {
            ...
            if (b) {
                ...
                if (b.open == c) h.apply(f, []); else {
                    var c = l(b, g.id.UL, a), i = l(b, g.id.SWITCH, a), o = l(b, g.id.ICON,
                        a);
            ...
            a.push("<span id='", c.tId, g.id.ICON, "' title='' treeNode", g.id.ICON, " class='", j.makeNodeIcoClass(b, c), "' style='", j.makeNodeIcoStyle(b, c), "'></span><span id='", c.tId, g.id.SPAN, "' class='", g.className.NAME, "'>",
                d, "</span>")
            ...
            var d = e.nodeTitle(b, c), f = j.makeNodeUrl(b, c), i = j.makeNodeFontCss(b,
                c), m = [], k;
            ...
            if (!b.isAjaxing) {
                ...
                (a.view.showIcon ==
                    !1 || !h.apply(a.view.showIcon, [a.treeId, b], !0)) && c.push("width:0px;height:0px;")
            }
            return c.join("")
            ...
            return g.className.BUTTON +
                " " + g.className.LEVEL + a.level + " " + g.className.SWITCH + " "
            ...
            if (b) if (typeof Element === "undefined") {
                ...
                (d.top <
                    c.top || d.bottom > c.bottom || d.right > c.right || d.left < c.left) && b.scrollIntoView()
            } else {
                if (!Element.prototype.scrollIntoViewIfNeeded) Element.prototype.scrollIntoViewIfNeeded = function (a) {
                    ...
                    function e(a, b) {
                        for (; a;) b = b.translate(a.offsetLeft, a.offsetTop),
                            a = a.offsetParent;
                        return b
                    }
            ...
            if (e.getNodeCache(a, b.tId)) {
                ...
                j.setLastNode(a, d);
                var k, i = f.length;
                if (!a.data.keep.parent && i ==
                    0) e.nodeIsParent(a, d, !1), d.open = !1, delete d[a.data.key.children], i = l(d, g.id.UL, a), h = l(d, g.id.SWITCH, a), k = l(d, g.id.ICON, a), j.replaceSwitchClass(d, h, g.folder.DOCU), j.replaceIcoClass(d, k, g.folder.DOCU), i.css("display", "none"); else if (a.view.showLine && i > 0) {
                    var q = f[i - 1], i = l(q, g.id.UL, a), h = l(q, g.id.SWITCH, a);
                    k = l(q, g.id.ICON, a);
                    d == c ? f.length == 1 ? j.replaceSwitchClass(q, h, g.line.ROOT) : (c = l(f[0], g.id.SWITCH, a), j.replaceSwitchClass(f[0], c, g.line.ROOTS), j.replaceSwitchClass(q, h, g.line.BOTTOM)) : j.replaceSwitchClass(q,
                        h, g.line.BOTTOM);
            ...
            if (b) {
                var c = l(b, g.id.SWITCH, a), d = l(b, g.id.UL, a), f = l(b, g.id.ICON, a), i = j.makeUlLineClass(a, b);
                i.length ==
                0 ? d.removeClass(g.line.LINE) : d.addClass(i);
    ...
    r.fn.zTree = {
        consts: {
            ...
            d.data.simpleData.enable ? e.nodeChildren(d, a, e.transformTozTreeFormat(d,
                c)) : e.nodeChildren(d, a, c);
            e.initCache(d);
            n.unbindTree(d);
            n.bindTree(d);
            n.unbindEvent(d);
            ...
            var f = {
                ...
                expandAll: function (a) {
                    ...
                    return !a ? null :
                        e.getNodesByParamFuzzy(d, c ? e.nodeChildren(d, c) : e.getNodes(d), a, b)
